    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-primary" href="{{ route('export_invoices') }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item"
                                                href=" {{ route('invoices.edit',$invoie->id) }}">تعديل الفاتورة</a>
                                            ...
                                            <a class="dropdown-item" href="#" data-id="{{ $invoie->id }}"
                                                ...
                                                الارشيف</a>
                                            <a class="dropdown-item" href="{{route('Print_invoice', $invoie->id)}}"><i
