    ...
    <div class="container-fluid">
        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                @if (Auth::user()->roles_users == ["owner"])
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notifications_count"> عدد الفواتير الغير مقروءة
                               :<span class="h4"> {{auth()->user()->unreadNotifications->count()}}</span> </p>
                        </div>
                            ...
                            <a class="d-flex p-3 border-bottom" href="{{route('InvoiceDetails' , $notification->data['id'])}}">
                                ...
                                <div class="mr-3">
                                    <h5 class="notification-label mb-1">
										{{-- تم اضافة فاتورة بواسطة : {{auth()->user()->name}}--}}
